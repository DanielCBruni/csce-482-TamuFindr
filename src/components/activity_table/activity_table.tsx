		...
		<div className="w-full overflow-x-auto rounded-lg border border-primary-muted/20 bg-white shadow-sm">
			<table className="w-full min-w-[720px] border-collapse text-left">
				...
				<thead className="bg-secondary/40 text-xs uppercase tracking-wider text-primary-muted">
					<tr>
						<th className="px-5 py-4 font-semibold" scope="col">Item</th>
						<th className="px-5 py-4 font-semibold" scope="col">Type</th>
						<th className="px-5 py-4 font-semibold" scope="col">Status</th>
						<th className="px-5 py-4 font-semibold" scope="col">Category</th>
						<th className="px-5 py-4 font-semibold" scope="col">Location</th>
						<th className="px-5 py-4 font-semibold" scope="col">Submitted</th>
					</tr>
				</thead>
